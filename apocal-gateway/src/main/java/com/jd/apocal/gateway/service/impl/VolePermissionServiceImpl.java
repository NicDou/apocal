  ...
  public boolean hasPermission(HttpServletRequest request,
    ...
    if (principal != null) {
      ...
      for (SimpleGrantedAuthority authority : grantedAuthorityList) {
        Set<PermissionVO> permissionVOSet = remotePermissionService
            .findPermissionByRole(authority.getAuthority());
      ...
      for (PermissionVO permission : permissionS) {
        if (permission != null
            ...
            && antPathMatcher.match(permission.getUrl(),
