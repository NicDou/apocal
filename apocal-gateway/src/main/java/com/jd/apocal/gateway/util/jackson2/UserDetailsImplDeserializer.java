...
import com.jd.common.vo.vo.RoleVO;
...
public class UserDetailsImplDeserializer extends JsonDeserializer<UserDetailsImpl> {
  ...
  @Override
  public UserDetailsImpl deserialize(JsonParser jp, DeserializationContext ctxt)
      throws IOException {
    ...
    List<RoleVO> roleVoList = mapper
        .convertValue(jsonNode.get("roleVoList"), new TypeReference<List<RoleVO>>() {
        });
