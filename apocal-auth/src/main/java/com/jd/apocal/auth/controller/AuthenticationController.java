package com.jd.apocal.auth.controller;
...
public class AuthenticationController {
  ...
  public RestServiceResult<Boolean> removeToken(String accesstoken) {
    return new RestServiceResult<>(consumerTokenServices.revokeToken(accesstoken));
  }
}